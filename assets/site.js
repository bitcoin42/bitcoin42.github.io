...
(function () {
  ...
  "bg.viz_appr_axis_0": "0 BTC",
  "bg.viz_appr_axis_1": "1 BTC",
  "bg.viz_appr_btn_cex": "A normal exchange",
  "bg.viz_appr_btn_nt": "Here",
  "bg.viz_appr_group": "Compare who can reach your balance",
  "bg.viz_appr_head": "Your balance: 1 BTC. You want to sell 0.2.",
  "bg.viz_appr_note_cex": "On a custodial exchange the whole balance sits in wallets they control, so the amount you meant to trade is not the boundary — their access is the boundary.",
  "bg.viz_appr_note_nt": "Orange is what your signature covers. The other 0.8 is not part of this transaction, so it cannot move with it.",
  "bg.viz_appr_seg_cex_a": "0.2 you meant to sell",
  "bg.viz_appr_seg_cex_b": "0.8 also in their hands",
  "bg.viz_appr_seg_rest": "0.8 untouched",
  "bg.viz_appr_seg_signed": "0.2 signed",
  "bg.viz_fee_cap": "The orange sliver on a €1,000 trade is the whole trading fee. It is drawn at its real width — that is how thin 0.125% is.",
  "bg.viz_fee_head": "0.125%, drawn to scale",
  "bg.viz_fee_lbl_fee": "fee",
  "bg.viz_fee_lbl_keep": "stays yours",
  "bg.viz_gap_cap": "The two devices only ever show each other pictures on a screen. There is no cable and no network between them, so there is no path for anything to reach the key over the internet.",
  "bg.viz_gap_head": "What crosses the gap",
  "bg.viz_gap_off_h": "Offline device",
  "bg.viz_gap_off_p": "Holds your key. Never connected to anything.",
  "bg.viz_gap_on_h": "Online device",
  "bg.viz_gap_on_p": "Talks to the exchange. Never sees your key.",
  "bg.viz_gap_void": "Camera only",
  "bg.viz_pool_cap": "On the left, your coins are mixed into one pot the company controls, and your balance is an entry in their database. On the right, the coins sit at an address that needs your key before anything can move.",
  "bg.viz_pool_cex_h": "A normal exchange",
  "bg.viz_pool_cex_pot": "Everyone's coins, one wallet, their key",
  "bg.viz_pool_cex_slip": "What you hold: a number on their screen",
  "bg.viz_pool_head": "Where the coins actually sit",
  "bg.viz_pool_nt_h": "NightTrader",
  "bg.viz_pool_nt_pot": "Your coins, your own address",
  "bg.viz_pool_nt_slip": "What you hold: one of the two keys that open it",
  "bg.viz_proof_cap": "This is how zkMe describes their process. We are showing you their design, not something we can verify from our side — and it is worth understanding what it means before you rely on it.",
  "bg.viz_proof_dev_h": "Your device",
  "bg.viz_proof_dev_p": "Passport, selfie, address — checked right here",
  "bg.viz_proof_dev_stays": "↑ never leaves this box",
  "bg.viz_proof_head": "What an ID check sends us",
  "bg.viz_proof_token": "✓ passed",
  "bg.viz_proof_us_h": "NightTrader",
  "bg.viz_proof_us_p": "Sees a yes-or-no answer. No documents, no name, no face.",
  "bg.viz_proof_wire": "only this travels",
  "bg.viz_timer_btn_1": "1 · You deposit",
  "bg.viz_timer_btn_2": "2 · You trade",
  "bg.viz_timer_btn_3": "3 · You stop",
  "bg.viz_timer_btn_4": "4 · Timer runs out",
  "bg.viz_timer_cap": "Step through it. Notice what stage 4 does and does not do: it changes who is allowed to spend, not where the coins are. Nothing is sent to you — you go and claim them.",
  "bg.viz_timer_group": "Recovery timer stages",
  "bg.viz_timer_head": "The recovery timer, step by step",
  "bg.viz_timer_note_1": "Your coins arrive and the timer is set. From here on, moving them needs your key and ours together.",
  "bg.viz_timer_note_2": "Every fill pushes the timer back to full. While you are trading normally, you never get near the far end.",
  "bg.viz_timer_note_3": "No trades, nothing to refresh it. Now the countdown actually moves — this is the only phase where it does.",
  "bg.viz_timer_note_4": "The rule in the script now lets your key spend on its own. Nothing has been sent anywhere: the coins are still sitting at the same address, and you (or a recovery tool) build and broadcast the transaction that moves them.",
  "bg.viz_timer_scale_full": "Full timer",
  "bg.viz_timer_scale_lock": "Locktime",
  "bg.viz_timer_state_1": "Timer set",
  "bg.viz_timer_state_2": "Timer refreshed",
  "bg.viz_timer_state_3": "Timer draining",
  "bg.viz_timer_state_4": "Locktime reached",
  "bg.viz_timer_who_both": "Needs both keys",
  "bg.viz_timer_who_you": "Your key alone is allowed",
  ...
  "history.tl_bitbay": "2015 · <a href=\"/bitbay-explained.html\">BitBay</a>",
