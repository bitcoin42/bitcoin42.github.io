...
(function () {
  ...
  T.en = {
    ...
    'history.p2':'Running machines was never the point. The order book was the plan from day one: a real exchange that never took custody of your coins, at a time when every exchange did exactly that. It took a decade — and watching custodian after custodian fail in the meantime — to build it right.',
    'history.tl1':'2014 · Bitcoin ATMs, Tijuana','history.tl2':'<em>2024 · NightTrader launches</em>',
    'history.citation':'Coverage from the time: <a href="https://www.coindesk.com/markets/2014/03/28/money-spinners-genesis1-bitcoin-and-dogecoin-atms-arrive-in-tijuana-mexico">CoinDesk, March 2014</a> — Genesis1 bitcoin and dogecoin ATMs arrive in Tijuana.',
  ...
  T.zh = {
    ...
    'history.p2':'运营 ATM 从来都不是最终目标。从第一天起,我们的计划就是打造一本真正的订单簿:一个从不托管你资金的真正交易所——而在当时,几乎每一家交易所都在做恰恰相反的事。我们花了整整十年,眼看着一个又一个托管方倒下,才把它真正做对。',
    'history.tl1':'2014 年 · 蒂华纳的比特币 ATM','history.tl2':'<em>2024 年 · NightTrader 上线</em>',
    'history.citation':'当时的报道:<a href="https://www.coindesk.com/markets/2014/03/28/money-spinners-genesis1-bitcoin-and-dogecoin-atms-arrive-in-tijuana-mexico">CoinDesk,2014 年 3 月</a> ——Genesis1 比特币与狗狗币 ATM 登陆蒂华纳。',
  ...
  T.ru = {
    ...
    'history.p2':'Обслуживание банкоматов никогда не было самоцелью. С самого первого дня целью был стакан заявок: настоящая биржа, которая никогда не забирает твои монеты в кастодию — в то время, когда именно так поступала каждая биржа. Понадобилось десять лет — и череда провалившихся один за другим кастодианов — чтобы сделать это правильно.',
    'history.tl1':'2014 · Биткоин-банкоматы в Тихуане','history.tl2':'<em>2024 · запуск NightTrader</em>',
    'history.citation':'Освещение того времени: <a href="https://www.coindesk.com/markets/2014/03/28/money-spinners-genesis1-bitcoin-and-dogecoin-atms-arrive-in-tijuana-mexico">CoinDesk, март 2014</a> — биткоин- и догикоин-банкоматы Genesis1 появляются в Тихуане.',
  ...
  T.es = {
    ...
    'history.p2':'Operar cajeros nunca fue el objetivo. El libro de órdenes fue el plan desde el primer día: un exchange real que nunca tomara custodia de tus monedas, en una época en que todos los exchanges hacían exactamente eso. Costó una década — viendo caer a un custodio tras otro mientras tanto — construirlo bien.',
    'history.tl1':'2014 · Cajeros de bitcoin, Tijuana','history.tl2':'<em>2024 · Lanzamiento de NightTrader</em>',
    'history.citation':'Cobertura de la época: <a href="https://www.coindesk.com/markets/2014/03/28/money-spinners-genesis1-bitcoin-and-dogecoin-atms-arrive-in-tijuana-mexico">CoinDesk, marzo de 2014</a> — llegan a Tijuana los cajeros Genesis1 de bitcoin y dogecoin.',
  ...
  T.pt = {
    ...
    'history.p2':'Operar caixas eletrônicos nunca foi o objetivo. O livro de ofertas era o plano desde o primeiro dia: uma exchange de verdade que nunca tomasse custódia das suas moedas, numa época em que toda exchange fazia exatamente isso. Levou uma década — vendo um custodiante após o outro falhar nesse meio-tempo — para construir isso direito.',
    'history.tl1':'2014 · Caixas eletrônicos de bitcoin, Tijuana','history.tl2':'<em>2024 · lançamento da NightTrader</em>',
    'history.citation':'Cobertura da época: <a href="https://www.coindesk.com/markets/2014/03/28/money-spinners-genesis1-bitcoin-and-dogecoin-atms-arrive-in-tijuana-mexico">CoinDesk, março de 2014</a> — chegam a Tijuana os caixas eletrônicos Genesis1 de bitcoin e dogecoin.',
  ...
  T.ar = {
    ...
    'history.p2':'تشغيل الأجهزة لم يكن الهدف قط. كان دفتر الأوامر هو الخطة منذ اليوم الأول: منصة تداول حقيقية لا تحتجز عملاتك أبداً، في وقت كانت فيه كل منصة تفعل ذلك بالضبط. استغرق الأمر عقداً كاملاً — ومشاهدة أمين حضانة تلو آخر يفشل خلال تلك الفترة — لبنائها بالشكل الصحيح.',
    'history.tl1':'2014 · أجهزة صراف آلي للبيتكوين، تيخوانا','history.tl2':'<em>2024 · انطلاق NightTrader</em>',
    'history.citation':'تغطية من ذلك الوقت: <a href="https://www.coindesk.com/markets/2014/03/28/money-spinners-genesis1-bitcoin-and-dogecoin-atms-arrive-in-tijuana-mexico">CoinDesk، مارس 2014</a> — وصول أجهزة صراف آلي من طراز Genesis1 للبيتكوين والدوجكوين إلى تيخوانا.',
  ...
  T.fr = {
    ...
    'history.p2':'Faire tourner des distributeurs n\'a jamais été le but. Le carnet d\'ordres était le projet dès le premier jour : un vrai exchange qui ne prendrait jamais tes pièces en garde, à une époque où tous les exchanges faisaient exactement ça. Il a fallu dix ans — en regardant dépositaire après dépositaire s\'effondrer entre-temps — pour bien le construire.',
    'history.tl1':'2014 · Distributeurs bitcoin, Tijuana','history.tl2':'<em>2024 · lancement de NightTrader</em>',
    'history.citation':'Couverture de l\'époque : <a href="https://www.coindesk.com/markets/2014/03/28/money-spinners-genesis1-bitcoin-and-dogecoin-atms-arrive-in-tijuana-mexico">CoinDesk, mars 2014</a> — les distributeurs Genesis1 pour bitcoin et dogecoin arrivent à Tijuana.',
  ...
  T.de = {
    ...
    'history.p2':'Automaten zu betreiben war nie das eigentliche Ziel. Das Orderbuch war der Plan von Tag eins an: eine echte Exchange, die nie die Verwahrung deiner Coins übernimmt — zu einer Zeit, in der genau das jede Exchange tat. Es brauchte ein Jahrzehnt — und den Anblick, wie ein Verwahrer nach dem anderen scheiterte —, um es richtig zu bauen.',
    'history.tl1':'2014 · Bitcoin-Geldautomaten, Tijuana','history.tl2':'<em>2024 · NightTrader startet</em>',
    'history.citation':'Berichterstattung von damals: <a href="https://www.coindesk.com/markets/2014/03/28/money-spinners-genesis1-bitcoin-and-dogecoin-atms-arrive-in-tijuana-mexico">CoinDesk, März 2014</a> — Genesis1-Geldautomaten für Bitcoin und Dogecoin kommen nach Tijuana.',
